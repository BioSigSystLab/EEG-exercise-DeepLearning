...
for fold=1,10 do
    ...
    SubjModel:add(nn.Linear(1024,8));
    ...
    local subj_feval = function(params)
        ...
        lambda = 10000;--1.2542; --loss/advLoss;
    ...
    local optimParams = {learningRate = 0.001, learningRateDecay = 0.0001, weightDecay = 0.01}
    local adv_optimParams = {learningRate = 0.001, learningRateDecay = 0.0001, weightDecay = 0.01}
    local _,loss
    local losses = {}
    local adv_losses = {}
