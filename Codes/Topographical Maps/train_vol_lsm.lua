...
local optimParams = {learningRate = 0.001, learningRateDecay = 0.001, weightDecay = 0.04}
local adv_optimParams = {learningRate = 0.001, learningRateDecay = 0.001, weightDecay = 0.04}
local _,loss
local losses = {}
local adv_losses = {}
